import { Title, createStyles, Space, Divider, Group, Text, SimpleGrid, Stack, Flex, Image, Container } from '@mantine/core';
    ...
    <Container fluid p={0}>
        <SimpleGrid cols={2} mx="md">
            ...
            <Stack align="flex-start" justify="flex-start" spacing={0} sx={{ zIndex: 1 }}>
                <Title size={64} className={classes.f300} sx={{ whiteSpace: 'nowrap' }} tt="capitalize"> Kevin </Title>
                <Title size={72} className={classes.f400} sx={{ whiteSpace: 'nowrap' }} tt="capitalize"> J. Griley </Title>
                <Title size={36} className={classes.f300} sx={{ whiteSpace: 'nowrap' }} tt="capitalize"> CTO & CFO </Title>
            </Stack>
        ...
        <Title order={2} className={classes.f400} tt="uppercase">About Me:</Title>
        <Divider size="xs" />
        <Space h="sm" />
        <Text>
